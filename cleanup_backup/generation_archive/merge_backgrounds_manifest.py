"""
Archived: merge_backgrounds_manifest.py

This helper merges generated SVG files into a manifest.json for the frontend.
Kept as an archive since generation is disabled.
"""
import os
import json
...
print(f'Wrote merged manifest with {len(variants)} variants to {MANIFEST_PATH} (archived)')
